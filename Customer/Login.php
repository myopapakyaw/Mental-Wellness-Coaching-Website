...
<body class="gradient-bg flex items-center justify-center min-h-screen">
    <div class="bg-white p-8 rounded-xl shadow-2xl w-full max-w-lg fade-in">
        <!-- Logo Section -->
        <div class="logo-container">
          <a href="Index.php"> <img src="../Img/11.png" alt="Company Logo" class="logo"></a> 
        </div>
        ...
        <p class="mt-4 text-center text-sm text-gray-600">
            Don't have an account? <a href="Signup.php" class="font-medium text-blue-600 hover:underline">Sign up</a>
        </p>
    </div>
</body>
</html>